...
async function main() {
    const validatorContractAddress = "0xF2D4Eeb4d455fb673104902282Ce68B9ce4Ac450";
    ...
    const validatorInstance = await ethers.getContractAt(
         validatorContractName,
    ...
    const v = await stateDeployHelper.upgradeValidator(validatorContractAddress,validatorContractName)
    console.log(
        validatorContractName,
