...
async function main() {
  const erc20Addr = '0xcC381ca2A190fbFd0059AB38A290E332AFe39b7b';
  const erc20 = await ethers.getContractAt('ERC20SelectiveDisclosureVerifierWithAttestations', erc20Addr);     
  const tx1 = await erc20.attest1();
  // console.log(tx1);
  const portalAddr = '0x7E8fdD0803BcC1A41cE432AdD07CA6C4E5F92eE2';
  const portal = await ethers.getContractAt('IPortal', portalAddr);
  console.log('attached to:', await portal.getAddress());
